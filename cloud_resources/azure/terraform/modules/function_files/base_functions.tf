...
resource "local_file" "host_json" {
    ...
    content_md5 = filemd5("${path.root}/../../../${var.function_folder}/azure/host.json")
}

resource "local_file" "requirements_txt" {
    source = "${path.root}/../../../${var.function_folder}/azure/requirements.txt"
    filename = "${local.output_folder}/requirements.txt"
    content_md5 = filemd5("${path.root}/../../../${var.function_folder}/azure/requirements.txt")
}
...
resource "local_file" "notify_function_json" {
    ...
    content_md5 = filemd5("${path.root}/../../../${var.function_folder}/azure/notify/function.json")
}
...
resource "local_file" "notify_notify_py" {
    ...
    content_md5 = filemd5("${path.root}/../../../${var.function_folder}/azure/notify/notify.py")
}
...
resource "local_file" "queue_file_function_json" {
    ...
    content_md5 = filemd5("${path.root}/../../../${var.function_folder}/azure/queue_file/function.json")
}
...
resource "local_file" "queue_file_queue_file_py" {
    ...
    content_md5 = filemd5("${path.root}/../../../${var.function_folder}/azure/queue_file/queue_file.py")
}
...
resource "local_file" "shared_notifier_common_py" {
    ...
    content_md5 = filemd5("${path.root}/../../../${var.function_folder}/common/notifier_common.py")
}